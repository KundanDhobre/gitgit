...
const employees: Employee[] = [{
  ID: 1,
  Head_ID: 0,
  Full_Name: 'Kundan Dhobre',
  Prefix: 'Mr.',
  Title: 'CEO',
  City: 'Hyderabad',
  State: 'India',
  Email: 'kundan@dx-email.com',
...

{
  ...
  ID: 2,
  Head_ID: 0,
  Full_Name: 'Ajay Singapuru',
  Prefix: 'Dr.',
  Title: 'COO',
  City: 'Los Angeles',
  State: '----',
  Email: 'ajay@dx-email.com',
  Skype: 'Ajayb_DX_skype',
  ...
  ID: 5,
  Head_ID: 1,
  Full_Name: 'Abhishek Banarasi Babu',
  Prefix: 'Ms.',
  Title: 'HR Manager',
  City: 'Atlanta',
  State: 'Georgia',
